...
import {handleGetApplicationById, handleGetApplicationsByUserId, handleGetSavedApplicationsByUserId, handleGetSentApplicationsByUserId, handlePostApplication, handlePutApplication, handleDeleteApplication, handeSendApplication, handleGetApplicationsByJob, handleDismissApplication, handleAcceptApplication} from '../controllers/applicationController';
...
applicationRoute.put('/accept/:application_id', authenticate, handleAcceptApplication);
